...
define ['services','archivoServicioCelda', 'archivoServicioBarco'], (services) ->
  services.service 'servicioTabla', (servicioCelda, servicioBarco) ->
      ...
      construirTabla: (dimension) ->
        ...
        for fila in [0..dimension-1]
          ...
          for columna in [0..dimension-1]
            tabla[fila][columna] = new servicioCelda(servicioCelda.ESTADO_CELDA_LIBRE,0)
        return tabla
    ...
    t = new Tabla(10)
    t.construirTablaEnemigo()
    t.llenarTabla()
    alert(t.existeEspacioHorizontal(4,1,new servicioBarco(1, 1,"" , 2, 3, "vertical")))
    alert(t.mostrarTabla())
